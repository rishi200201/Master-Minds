      ...
      <div className="contact-us pt-90 pb-90">
        <div className="container text-center">
          ...
          <p className="section-description">
            No! You are not going to hit a long wait line to reach a real person.
            Neither is your email reaching any blackhole where things just disappear.
            Our customer-first approach makes it natural to answer every query, request,
            or just a comment at a record response time.
          </p>
          <div className="row justify-content-center">
            {/* Repeat the contact-card div as needed */}
            {[
              {
                imgSrc: "/assets/images/about/sqa.png.jpg",
                altText: "Eswatini Flag",
                title: "Address:",
                content: "Business Eswatini, No. 4, Malagwane Hill, Mbabane, Kingdom of Eswatini (Swaziland). <br /> Phone: +268 7844 6897 / +268 7828 6957",
              },
              {
              ...
              <div className="col-md-4 mb-4" key={index}>
                <div className="contact-card">
                  <div className="card-content">
                    <img src={item.imgSrc} alt={item.altText} className="flag-icon" />
                    <h4>{item.title}</h4>
          ...
          <div className="row justify-content-center">
            <div className="col-md-8">
              ...
              <p className="form-description">
                Just fill in this short form and our experts will reach you in no time:
              </p>
              <form>
